...
func TestHandleFileWithBiggerSecondSequence(t *testing.T) {
...
func TestHandleFileWithJpegEasy(t *testing.T) {
...
func TestHandleFileSmallerSecondSequence(t *testing.T) {
...
func TestHandleFileFailures(t *testing.T) {
...
func TestHandleFileContinuous(t *testing.T) {
